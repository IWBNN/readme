...
<!-- 본 서비스는 보이스 채팅을 지원하지 않는 게임에서 친구들과 쉽게 소통하고, 같이 게임할 친구를 찾기 힘든 유저들을 위한 솔루션입니다. -->
사용자들은 게임 중 실시간 소통을 원하지만, 많은 게임에서 보이스 채팅 기능을 제공하지 않습니다.
또한, 같이 게임을 즐길 친구를 찾는 것이 어렵다는 문제를 겪고 있습니다.
이 문제를 해결하기 위해 보이스톡과 채팅 기능을 제공하고, 게임 별로 방을 생성하여 손쉽게 유저를 구할 수 있는 서비스를 제공하고자 했습니다.

<br/>

## 🌁 프로젝트 배경
많은 게임 유저들이 보이스 채팅 기능이 없는 게임을 하면서 실시간 소통에 어려움을 겪고 있습니다.
또한, 함께 게임할 친구를 찾기 위해 다른 플랫폼을 이용해야 하는 불편함이 있습니다.
이 서비스는 이러한 문제를 해결하여, 게임 중 실시간 소통을 가능하게 하고, 유저가 손쉽게 친구를 구할 수 있는 환경을 제공하는 것을 목표로 합니다.

타 서비스는 단순한 친구 매칭이나 채팅 기능만 제공할 뿐, 보이스톡과 게임 방을 결합한 형태의 서비스는 부족한 상황이었습니다.


따라서 이 문제를 해결하기 위해 누구나 손쉽게 접근하여 보이스톡과 채팅 기능을 활용한 게임 방을 생성할 수 있는 웹 서비스를 제공하고자 합니다.
단순히 게임 친구를 찾는 기능뿐만 아니라, 게임 별로 맞춤형 방을 제공하여 함께 플레이할 친구를 찾는 어려움을 줄일 수 있을 것입니다.
